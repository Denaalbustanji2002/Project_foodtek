...
import 'package:foodtec/view/screens/authentication_screens/update_password.dart' show SendResetLinkForgotPasswordScreen;
...
import '../../widget/spin_kit_hour_glass_widget.dart';
            ...
            child: Row(
              ...
              children: [
                SizedBox(
                  width: responsiveWidth(context, 18),
                  height: responsiveHeight(context, 18),
                  child: Image.asset('assets/images/2021_Facebook_icon 1.png'),
                ),
                const SizedBox(width: 10),
                Text(
